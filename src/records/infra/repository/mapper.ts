import { Record as EntityRecord } from '@/records/domain/record';
import { SequelizeRecord } from '@/shared/infra/database/models/Record';
import { toSingleOperation } from '@/operations/infra/repository/mapper';
import { toSingleUser } from '@/users/infra/repository/mapper';
